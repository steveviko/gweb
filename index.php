			  ...
			  <div class="py-3" style="width:80%">
			    <h6 class="card-title">social media links</h6>
					<div>
						...
						<a href="#" class="btn btn-icon btn-secondary  btn-small"><i class="fab fa-facebook-f"></i></a>
						</div>
			  </div> 
   ...
   <div class="row no-gutters items-wrap">
	...
	?>
		...
		<?php }  ?>
			...
			<div class="col-md col-6">
		<?php
    $ret=mysqli_query($bd,"select * from products WHERE sex='Female' ORDER BY sex desc LIMIT 0,1");
    $num=mysqli_num_rows($ret);    
    while ($row=mysqli_fetch_array($ret))
	...
	?>
		...
		<div class="col-md col-6">
		<?php
    $ret=mysqli_query($bd,"select * from products ORDER BY id DESC LIMIT 0,1");
    $num=mysqli_num_rows($ret);    
    while ($row=mysqli_fetch_array($ret))
...
<ul class="row no-gutters bordered-cols">
<?php
	$ret=mysqli_query($bd,"select * from products  ORDER BY id 
      LIMIT
    0,8");
	while ($row=mysqli_fetch_array($ret)) 
	{
...
<div class="card card-body">
	...
	<div class="form-group">
			<input class="form-control" name="username" placeholder="Enter Full Name" type="text">
		</div>
		<div class="form-group">
		...
		<div class="form-group text-muted">
			...
			<label class="form-check form-check-inline">
			  <input class="form-check-input" name="price" type="checkbox" value="provide price of item">
			  <div class="form-check-label">Request price</div>
			</label>
			<label class="form-check form-check-inline">
			  <input class="form-check-input" name="date" type="checkbox" value="provide date of delivery">

...
$ret=mysqli_query($bd,"select productImage2 from products where id='$pid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($bd,"update  products set productImage2='$productimage2' where id='$pid' ");
...
$query=mysqli_query($bd,"select productName,productImage2 from products where id='$pid'");
$cnt=1;

...
?>
									...
									<li>
										...
										<?php	
	$status='Pending';									 
$ret = mysqli_query($bd,"SELECT * FROM Orders where orderStatus='$status'");
...
<ul class="widget widget-menu unstyled">
						...
						<ul class="widget widget-menu unstyled">
							...
							<li><a href="message.php"><i class="menu-icon icon-tasks"></i>Messages </a></li>
							<li><a href="reserve.php"><i class="menu-icon icon-tasks"></i>Reservations </a></li>
							<li><a href="subscribe.php"><i class="menu-icon icon-tasks"></i>subscribtions </a></li>
							<li>
								<a href="logout.php">
